...
public class IntentToOutA extends QProjectItem {
	...
	protected void onInit() {
		...
		btn.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				QIntent.contentImage(IntentToOutA.this, REQUEST_IMAGE);
			}
		});
		//
		btn = getNextButton();
		...
		btn.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				QIntent.mediaCamera(IntentToOutA.this, REQUEST_IMAGE);
			}
		});
		//
		btn = getNextButton();
		...
		btn.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				QIntent.mapGoogle(ctx, "23.122359", "113.302746", null);
			}
		});
	}
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		switch(requestCode){
		case REQUEST_IMAGE:
			Bitmap bm = QIntent.resultBitmap(this, data);
			if(bm != null){
